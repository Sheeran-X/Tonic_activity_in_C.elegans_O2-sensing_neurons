...
<!-- generated with COPASI 4.28 (Build 226) (http://www.copasi.org) at 2020-08-24T05:18:21Z -->
  ...
  <rdf:Description rdf:about="#Reaction_45">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5333" name="k1" value="0.08"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_48">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5332" name="kf" value="0.5"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_49">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5330" name="k2" value="1e-07"/>
          <Constant key="Parameter_5329" name="vM2" value="1.5e-05"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_50">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5328" name="k1" value="2.41434e-06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_51">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5327" name="k1" value="3.9e-10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_52">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5326" name="k1" value="-1.23403e-10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[Extracellular space]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_53">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5325" name="k1" value="4.09979e-17"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_54">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5324" name="k1" value="-1.35378e-06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_55">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5323" name="k1" value="4.2843e-17"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_56">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5322" name="k1" value="1.215e+19"/>
          <Constant key="Parameter_5321" name="k2" value="1425"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_57">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5315" name="k2" value="1930"/>
          <Constant key="Parameter_5314" name="k1" value="4.05e+12"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[subspace]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-08-24T05:14:09Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[ER],Vector=Metabolites[Ca_ER]" value="9033.2113177744832" type="Species" simulationType="reactions"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Values[\[Ca\]_ion_intracellular]" value="2.8388425699695079e-20" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Values[J_trans]" value="4.5004766803070716e-17" type="ModelValue" simulationType="assignment"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[CICR through IP3R]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[CICR through IP3R],ParameterGroup=Parameters,Parameter=k1" value="0" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          ...
          <ModelParameterGroup cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[Diffusion from ER to JER]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[Diffusion from ER to JER],ParameterGroup=Parameters,Parameter=k1" value="4.5004766803070716e-17" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-08-24T05:14:04Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
