...
<!-- generated with COPASI 4.28 (Build 226) (http://www.copasi.org) at 2020-08-24T05:30:13Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
    ...
    <Function key="Function_40" name="Rate Law for ER Leak flux" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_40">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_264" name="ER" order="0" role="volume"/>
        <ParameterDescription key="FunctionParameter_263" name="kf" order="1" role="constant"/>
        <ParameterDescription key="FunctionParameter_262" name="Ca_ER" order="2" role="substrate"/>
        <ParameterDescription key="FunctionParameter_261" name="Ca" order="3" role="product"/>
      </ListOfParameterDescriptions>
    </Function>
    <Function key="Function_41" name="Rate Law for CICR_backup" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_41">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_267" name="cytoplasm" order="0" role="volume"/>
        <ParameterDescription key="FunctionParameter_266" name="Ca_ER" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_265" name="Ca" order="2" role="product"/>
        <ParameterDescription key="FunctionParameter_250" name="L" order="3" role="constant"/>
        <ParameterDescription key="FunctionParameter_268" name="P_IP3R" order="4" role="constant"/>
        <ParameterDescription key="FunctionParameter_269" name="IP3" order="5" role="modifier"/>
        <ParameterDescription key="FunctionParameter_270" name="h" order="6" role="constant"/>
        <ParameterDescription key="FunctionParameter_271" name="Ki" order="7" role="constant"/>
        <ParameterDescription key="FunctionParameter_272" name="Ka" order="8" role="constant"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
  ...
  <rdf:Description rdf:about="#Reaction_47">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5333" name="P_IP3R" value="66.6"/>
          <Constant key="Parameter_5332" name="h" value="0.00677558"/>
          <Constant key="Parameter_5334" name="L" value="0.00093"/>
  ...
  <rdf:Description rdf:about="#Reaction_49">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5326" name="k1" value="0"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_50">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5325" name="k1" value="2.41434e-06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_51">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5324" name="k1" value="3.9e-10"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_52">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5323" name="k1" value="-1.23403e-10"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[Extracellular space]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_53">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5322" name="k1" value="4.09979e-17"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_54">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5321" name="k1" value="-1.35378e-06"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[cytosol]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
  ...
  <rdf:Description rdf:about="#Reaction_55">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5315" name="k1" value="4.29412e-17"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_56">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5314" name="k1" value="1.215e+19"/>
          <Constant key="Parameter_5313" name="k2" value="1425"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_57">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5312" name="k2" value="1930"/>
          <Constant key="Parameter_5311" name="k1" value="4.05e+12"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[subspace]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
  ...
  <rdf:Description rdf:about="#Reaction_58">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5310" name="k2" value="0.8"/>
          <Constant key="Parameter_5309" name="k1" value="18"/>
        </ListOfConstants>
        <KineticLaw function="Function_14" unitType="Default" scalingCompartment="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Compartments[subspace]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_69">
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-08-24T05:27:53Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[Serca]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Oxygen sensing related Calcium signalling model,Vector=Reactions[Serca],ParameterGroup=Parameters,Parameter=k1" value="0" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-08-24T05:27:48Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
